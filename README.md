...
# praktikum_2:
  judul: Menghubungkan Perangkat Android atau Emulator
  langkah_langkah:
    - Hubungkan perangkat Android/iOS atau buka emulator.
...
# praktikum_3:
  judul: Membuat Repository GitHub dan Laporan Praktikum
  langkah_langkah:
...
# praktikum_5:
  judul: Menerapkan Widget Material Design dan iOS Cupertino
  ## langkah_1:
    nama: Cupertino Button dan Loading Bar
    langkah:
 ...
 ## langkah_2:
    nama: Floating Action Button (FAB)
    langkah:
 ...
 ## langkah_5:
    nama: Input dan Selection Widget
    langkah:
